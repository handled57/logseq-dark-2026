...
test('package tags select one version-matched release archive', async () => {
  assert.deepEqual(await selectRelease('theme-v2.5.0'), {
    archive: 'dist/logseq-dark-high-contrast-theme-2.5.0.zip',
    release_name: 'Dark High Contrast 2.5.0',
    workspace: 'packages/dark-high-contrast'
  })
  assert.deepEqual(await selectRelease('passage-v0.5.0'), {
    archive: 'dist/logseq-passage-0.5.0.zip',
    release_name: 'Passage 0.5.0',
