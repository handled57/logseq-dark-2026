...
The pane's clock, speech-bubble and hand icons in `index.js` are simplified
from the path data of [Tabler Icons](https://tabler.io/icons) (`clock`,
`message-circle` and `hand-stop`).

- License: MIT
- Copyright: Paweł Kuna and contributors
