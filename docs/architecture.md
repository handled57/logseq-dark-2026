...
original rail axis. There are no curves, horizontal arms, distance calculations,
or child-group spacing changes. Flat mode and unloading remove both markers.
...
Collapsed parents have a crisp 2px outer ring with a 2px gap. Expanded parents use a hollow 3px ring in the bullet color with a 13px outer diameter. An opaque black parent control masks the rail inside the ring and gap; the ring itself is fully opaque. There are no blurred shadows.
